...
- In order for CMake to detect your source files (.cpp) you must include them in the **app_src.cmake** file which is located in the **is-Engine-TMXLite/app/src/main/cmake** location.
...
#### All
3. Or open the **is-Engine-TMXLite/app/src/main** folder with **Solution Explorer**.
...
2. Or open the file **is-Engine-windows.cbp** in the location **is-Engine-TMXLite/app/src/main**
...
```
2. Or open the file **is-Engine-linux.cbp** in the location **is-Engine-TMXLite/app/src/main**.
...
- You want to participate in the development of the engine, good ! Welcome to the team!
